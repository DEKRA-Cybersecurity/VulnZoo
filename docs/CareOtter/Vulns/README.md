...
| [API-01](API1_BOLA.md) | Broken Object Level Authorization (BOLA) — Cross-User Vitals Access | API | ✅ COMPLETADA | High | CWE-639 / CWE-863 |
| [API-02](API2_Broken_Authentication.md) | Broken Authentication | API | ✅ COMPLETADA | High | CWE-287 / CWE-308 / CWE-759 |
| [API-06](API6_BFLA.md) | Broken Function Level Authorization (BFLA) | API | ✅ COMPLETADA | High | CWE-863 |
...
| Badge | Meaning |
|-------|---------|
| ✅ COMPLETADA | Vulnerability is implemented in code and verified in the lab environment. |
| ⏳ PENDIENTE | Vulnerability is documented but not yet implemented or not yet verified. |
| 🚧 EN DESARROLLO | Implementation is in progress; do not use for lab verification yet. |
