...
| Layer | File | Purpose |
|-------|------|---------|
| Layer 0 | `KIMI.md` | Global identity, folder structure |
| Layer 1 | `CONTEXT.md` | Workspace task routing |
| Layer 2 | `labs/<device>/CONTEXT.md` | Stage-specific contracts |
| Layer 3 | `docs/` | Reference documentation |

See `Interpretable_Context_Methdology_.pdf` for MWP details.
